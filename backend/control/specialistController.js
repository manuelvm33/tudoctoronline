// Import Specialist model
const mySpecialistModel = require('../model/specialist');

// Exports each function to complement the CRUD operations
exports.create = async (req, res) => {
    try {
        let specialist = new mySpecialistModel(req.body);
        console.log('Function create specialist => ', specialist);
        await specialist.save();
        res.json(specialist);
    } catch (error) {
        console.log('An error occurred while a specialist was created: ', error);
...
exports.getAll = async (req, res) => {
    try {
        ...
        console.log('An error occurred while the specialists were searched: ', error);
...
exports.getById = async (req, res) => {
    try {
        ...
        console.log('An error occurred while the specialist to find was searched: ', error);
...
exports.update = async (req, res) => {
    try {
        ...
        console.log('An error occurred while the specialist to update was searched: ', error);
...
exports.delete = async (req, res) => {
    try {
        ...
        console.log('An error occurred while the specialist to delete was searched: ', error);
        res.status(500).send('an error has ocurred while the specialist to delete was searched');
    }
};