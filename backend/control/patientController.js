...
exports.create = async (req, res) => {
    try {
        let patient = new myPatientModel(req.body);
        console.log('Function create patient => ', patient);
        await patient.save();
        res.json(patient);
    } catch (error) {
        console.log('An error occurred while a patient was created: ', error);
...
exports.getAll = async (req, res) => {
    try {
        ...
        console.log('An error occurred while the patients were searched: ', error);
...
exports.getById = async (req, res) => {
    try {
        ...
        console.log('An error occurred while the patient to find was searched: ', error);
...
exports.update = async (req, res) => {
    try {
        ...
        console.log('An error occurred while the patient to update was searched: ', error);
...
exports.delete = async (req, res) => {
    try {
        ...
        console.log('An error occurred while the patient to delete was searched: ', error);
        res.status(500).send('an error has ocurred while the patient to delete was searched');
    }
};