...
exports.create = async (req, res) => {
    try {
        let medical_appointment = new myMedical_appointmentModel(req.body);
        console.log('Function create medical_appointment => ', medical_appointment);
        await medical_appointment.save();
        res.json(medical_appointment);
    } catch (error) {
        console.log('An error occurred while a medical appointment was created: ', error);
...
exports.getAll = async (req, res) => {
    try {
        ...
        console.log('An error occurred while the medical appointments were searched: ', error);
...
exports.getById = async (req, res) => {
    try {
        ...
        console.log('An error occurred while the medical appointment to find was searched: ', error);
...
exports.update = async (req, res) => {
    try {
        ...
        console.log("Medical appointment found => ", medical_appointmentToUpdate);
        ...
        console.log('An error occurred while the medical appointment to update was searched: ', error);
...
exports.delete = async (req, res) => {
    try {
        ...
        console.log('An error occurred while the medical appointment to delete was searched: ', error);
